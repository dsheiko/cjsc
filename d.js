...
_require.def( "demo/main-flow/dep1.js", function( _require, exports, module, global ){
console.log( "main.js running..." );
console.log( "Imported name in main.js is `%s`", _require( "demo/main-flow/dep1.js" ).name );
console.log( "Getting imported object from the cache:" );
console.log( " imported name in main.js is still `%s`", _require( "demo/main-flow/dep1.js" ).name );
	return module;
});
...
_require.def( "demo/main-flow/dep2.js", function( _require, exports, module, global ){
	var __dirname = "demo/main-flow", __filename = "demo/main-flow/dep2.js", __modulename = "module:demo/main-flow/dep2";
...
console.log( "Imported name in dep1.js is `%s`", _require( "demo/main-flow/dep2.js" ).name );
exports.name = "dep1";
	module.exports = exports;
	return module;
});

_require.def( "demo/main-flow/submodule/dep3.js", function( _require, exports, module, global ){
console.log( "dep2.js running..." );
console.log( "Imported name in dep2.js is `%s`", _require( "demo/main-flow/submodule/dep3.js" ).name );
console.log( "Imported name in dep2.js is `%s`", _require( "demo/main-flow/submodule/dep4.js" ).name );
module.exports.name = "dep2";
	return module;
});

_require.def( "demo/main-flow/submodule/dep4.js", function( _require, exports, module, global ){
console.log( "dep2.js running..." );
console.log( "Imported name in dep2.js is `%s`", _require( "demo/main-flow/submodule/dep3.js" ).name );
console.log( "Imported name in dep2.js is `%s`", _require( "demo/main-flow/submodule/dep4.js" ).name );
module.exports.name = "dep2";
...
(function(){
_require( "demo/use-main-flow.js" );
}());
