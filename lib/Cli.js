    ...
    */
    ...
    parseTransformOptions: function( args ){
      var that = this,
           ...
           * @returns {String}
           */
          unescapeStrs = function( opts ) {
           var i;
            if ( typeof opts !== "object" ) {
              return opts;
            }
            for( i in opts ) {
              if ( opts.hasOwnProperty( i ) && typeof opts[ i ] === "string" ) {
          ...
          parse = function( str ) {
            ...
            slices.slice( 1 ).forEach(function( pairStr ){
              ...
              try {
                ...
                targets[ target ].push(  opts ? unescapeStrs( global.JSON.parse( opts ) ) : true );
              } catch( e ) {
    ...
    parseCliOptions: function( rawArgs ) {
      ...
      this.plugins && this.plugins.forEach(function( c ){
        that.options.debug && console.log( clc.yellow( " Registered plugin `%s`" ), c.plugin );
      });
