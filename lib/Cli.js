...
*/
	...
	module.exports = function( srcPath, cwd, fsContainer, pathContainer ) {
			var startTime = process.hrtime(),
					...
					pathDiff = "",
					/**
					 * Src path relative to project directory
					 * @type {string}
					 */
					relSrcPath = pathContainer.relative( cwd, srcPath );
			...
			return {
				...
				*/
				 ...
				 */
				getRelativeToSrcPath: function( mapFile ){
					var relMapPath = pathContainer.relative( cwd, pathContainer.dirname( mapFile ) );
